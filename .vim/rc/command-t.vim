...
" this setting to a non-zero value to override this behavior and
" recurse.
...
" regardless of whether the search string contains a dot.
let g:CommandTAlwaysShowDotFiles = 1

" A list of file patterns.  A file that matches with one of these
" patterns is ignored when completing file or directory names, and
" influences the result of |expand()|, |glob()| and |globpath()| 
" unless a flag is passed to disable this.
